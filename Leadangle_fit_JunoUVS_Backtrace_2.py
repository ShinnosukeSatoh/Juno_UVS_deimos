...
def Obsresults(PJ_LIST, TARGET_MOON, TARGET_FP, TARGET_HEM, FLIP):
    ...
    # 余計な部分を削除
    wlon_fp = wlon_fp[3:]               # Jovigraphic
    err_wlon_fp = err_wlon_fp[3:]       # Jovigraphic
    lat_fp = lat_fp[3:]                 # Jovigraphic
    err_lat_fp = err_lat_fp[3:]         # Jovigraphic
    wlon_moon_fp = wlon_moon_fp[3:]     # Jovicentric
    et_fp = et_fp[3:]
    hem_fp = hem_fp[3:]
    pj_fp = pj_fp[3:]
